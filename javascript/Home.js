let apiTaskApi = new TempApi.TaskApi();import TempApi from '../src/index';document.getElementById('iyj6').onclick = (event) => {
    ...
    event.preventDefault();
    {   location.href= '/addTask' ;}};document.getElementById('ibhhqh').onclick = (event) => {
    event.preventDefault();
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ibhhqh")) === true &&
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ig1oej').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ig1oej")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ifrk8f').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ifrk8f")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ipqoah').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ipqoah")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ibnutt').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ibnutt")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('io2103').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("io2103")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('iw23xt').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("iw23xt")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ik9zw6').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ik9zw6")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('ixzx0y').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ixzx0y")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('im3ahz').onclick = (event) => {
    event.preventDefault();
    {  
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("im3ahz")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
